defmodule DistributedTaskQueue.Job do
  ...
  def changeset(job, attrs) do
    job
    |> cast(attrs, [:payload, :worker_module, :queue_name, :status, :attempts, :max_attempts, :error_message, :scheduled_at, :started_at, :next_retry_at, :completed_at, :discarded_at, :deleted_at])
